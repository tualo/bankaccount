Ext.define('Tualo.bankaccount.lazy.Viewport', {
    extend: 'Ext.panel.Panel',
    requires: [
        'Tualo.bankaccount.lazy.controller.Viewport',
        'Tualo.bankaccount.lazy.model.Viewport',
    ],
    alias: 'widget.bankaccountviewport',
